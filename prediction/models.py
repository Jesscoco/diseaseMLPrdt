...
class Historics(models.Model):
    ...
    symptom_n1 = models.CharField(max_length=100, choices=SYMPTOMS)
    symptom_n2 = models.CharField(max_length=100, choices=SYMPTOMS)
    symptom_n3 = models.CharField(max_length=100, choices=SYMPTOMS)
